...
Are you looking to integrate this into a product? privveeeet We have a turn-key hosted API with new and improved lip-syncing models here: https://synclabs.so/
